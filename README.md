...
**[Download pre-built binary (64-bit)](https://github.com/dermike/physical-web-scan-app/releases/download/0.3.0/PhysicalWebScan.zip)** or follow the instructions below to run with Electron or build your own binary.
